...
describe 'ipcalc::greater_than' do
  ...
  it { is_expected.to run.with_params('127.0.0.1/32', '127.0.0.2/24').and_return(false) }
  it { is_expected.to run.with_params('127.0.0.1/32', '127.0.0.2').and_return(false) }
  it { is_expected.to run.with_params('127.0.0.1/32', '127.0.0.1/24').and_return(true) }
  ...
  it { is_expected.to run.with_params('fe80::1/128', 'fe80::2/120').and_return(false) }
  it { is_expected.to run.with_params('fe80::1/128', 'fe80::2').and_return(false) }
  it { is_expected.to run.with_params('fe80::1/128', 'fe80::1/120').and_return(true) }
